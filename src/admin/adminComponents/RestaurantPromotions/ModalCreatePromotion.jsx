...
export default function ModalCreatePromotion({isOpen, onOpen, onClose}) {
    ...
    const createPromotion = async (discountDetails,
                                   availableDate,
                                   restaurantName,
                                   image,
                                   discountDays) => {
                        ...
                        <Box display='flex' flexDirection='column'>
                            ...
                            >
                                <Image
                                    ...
                                    height='100%'
                                    borderRadius='20px'
                                    src={image || 'https://images.pexels.com/photos/1640777/pexels-photo-1640777.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'}
                                    objectFit='cover'
                        ...
                        <Box display='flex' flexDirection='column' gap={3}>
                            <InputGroup mt='20px' display='flex' flexDirection='column'>
                                ...
                                <Controller
                                    ...
                                    defaultValue=''
                                    render={({field}) => (
                                        <Input {...field} color='neutral.gray' fontSize='2xs' type='text'
                            ...
                            <Box>
                                {arrDaysOfTheWeek.map((day, i) => {
                                    return (
                                        <Button key={i} border='1px' color='neutral.gray' marginRight='12px'
                                                borderRadius='16px'>
                                            {day}
                                        </Button>
                                    )
