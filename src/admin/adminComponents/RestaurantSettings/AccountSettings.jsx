...
export default function AccountSettings() {
    ...
    const fetchAdmin = async () => {
        try {
            ...
            if (response.data.success) { // Проверка успешности запроса
            ...
            <Box borderRadius='16px' borderWidth='1px' py='20px' px='10px'>
                    ...
                    <Grid templateColumns={{base: 'repeat(1, 1fr)', md: '1fr 1fr 1fr '}} gap={6}>
                        ...
                        <GridItem w='100%'>
                            <FormControl id='phone'>
                                <FormLabel fontWeight='semibold' placeholder='+1(217) 555-0113' fontSize='3xs'
                ...
                <Box pt={5}>
                    ...
                    <Grid templateColumns={{base: 'repeat(1, 1fr)', md: '1fr 1fr  '}} gap={{base: 4, md: 6}}>
                        <GridItem w='100%'>
                            <Stack mt={2} direction={{base: 'column', sm: 'row'}} align={'start'}
                            ...
                            <Stack mt={4} direction={{base: 'column', sm: 'row'}} align={'start'}
                                   justify={'space-between'}>
                                <Flex alignItems='center'>
