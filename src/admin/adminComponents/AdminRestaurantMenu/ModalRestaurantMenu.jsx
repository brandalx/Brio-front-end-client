                        ...
                        <Box display='flex' flexDirection='row' gap={3}>
                            <InputGroup mt='20px' display='flex' flexDirection='column'>
                                ...
                                <Controller
                                    ...
                                    name='name'
                                    defaultValue=''
                                    render={({ field }) => <Input {...field} color='neutral.gray' fontSize='2xs' type='text' placeholder='Enter meal name' />}
                                />
                            </InputGroup>
                            <InputGroup mt='20px' display='flex' flexDirection='column'>
                                <Text fontSize='3xs' fontWeight='semibold' color='neutral.black'>
                                ...
                                <Controller
                                    ...
                                    name='price'
                                    defaultValue=''
                                    render={({ field }) => <Input {...field} color='neutral.gray' fontSize='2xs' placeholder='Enter meal price' type='number' />}
                                />
                            </InputGroup>
                        </Box>
                        <Box display='flex' flexDirection='row' gap={3}>
                            <InputGroup mt='20px' display='flex' flexDirection='column'>
                                ...
                                <Controller
                                    ...
                                    name='description'
                                    defaultValue=''
                                    render={({ field }) => <Input {...field} color='neutral.gray' fontSize='2xs' type='text' placeholder='Enter meal description' />}
                                />
                            </InputGroup>
                        </Box>
                        <Box display='flex' flexDirection='row' gap={3}>
                            <InputGroup display='flex' flexDirection='column'>
                                ...
                                <Controller
                                    ...
                                    name='ingredients'
                                    defaultValue=''
                                    render={({ field }) => <Input {...field} color='neutral.gray' fontSize='2xs' placeholder='Enter meal ingredients' type='text' />}
                                />
                            </InputGroup>
                            <InputGroup display='flex' flexDirection='column'>
                                <Text fontSize='3xs' fontWeight='semibold' color='neutral.black'>
                                ...
                                <Controller
                                    ...
                                    defaultValue=''
                                    render={({ field }) => <Input {...field} color='neutral.gray' fontSize='2xs' placeholder='Enter meal nutritional value' type='number' />}
                                />
                            </InputGroup>
                        </Box>
                    </Box>
